...
INSERT INTO album(title, price, genre, img_url, artist_id)
	VALUES("Let Go", 10, "Pop", "letgo.png", (SELECT artist_id FROM artist WHERE name = "Avril Lavigne"));
INSERT INTO album(title, price, genre, img_url, artist_id)
	VALUES("Under My Skin", 10, "Pop", "undermyskin.jpg", (SELECT artist_id FROM artist WHERE name = "Avril Lavigne"));
INSERT INTO album(title, price, genre, img_url, artist_id)
